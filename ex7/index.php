...
<body>
    <div>
        <p>問7） 問6の応用として、下記の処理を実装してください。</p>
        <ul>
            <li>
    ...
    <form action="./question.php" method="POST">
        ...
        <!-- <div class="questionNum">
            <label for="">最小値:</label><input type="text" name="min" value="1" id="">
            <label for="">最大値:</label><input type="text" name="max" value="100" id="">
            <label for="">問題数:</label><input type="text" name="questionNum" value="10" id="">
        </div> -->
